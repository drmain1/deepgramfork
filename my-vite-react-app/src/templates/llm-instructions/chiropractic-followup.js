...
---
{
  ...
  "cranial_nerve_examination": [
      { "cranial_nerve": "CN I: Olfactory", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN II: Optic", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN III: Oculomotor", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN IV: Trochlear", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN V: Trigeminal", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN VI: Abducens", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN VII: Facial", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN VIII: Vestibulocochlear", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN IX: Glossopharyngeal", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN X: Vagus", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN XI: Accessory", "previous_finding": "string", "current_finding": "string" },
      { "cranial_nerve": "CN XII: Hypoglossal", "previous_finding": "string", "current_finding": "string" }
  ] | null,
...
2.  **Carry-Forward Rule (CRITICAL EXCEPTION):** If a test was documented as **ABNORMAL** in the initial data but is NOT mentioned at all in the current re-evaluation, you MUST carry it forward as unchanged to prevent loss of significant clinical data. For example, if initial SLR was 'positive' and re-eval dictation doesn't mention SLR, the entry should be \`{ "test_name": "SLR", "previous_result": "positive", "current_result": "positive" }\`.
