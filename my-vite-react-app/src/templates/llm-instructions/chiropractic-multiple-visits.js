export const chiropracticMultipleVisitsInstructions = `
System Role:
...
Primary Task:
This transcription software is going to be used for multiple patients, The doctor will say new patient and a first and last name this indicates to start a fresh soap note, and a new paragraph should be started. 
